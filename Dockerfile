...
RUN cd ~ \
    ...
    && ln -s /root/.composer/vendor/squizlabs/php_codesniffer/src/Standards/Symfony2-coding-standard/Symfony \
       /root/.composer/vendor/squizlabs/php_codesniffer/src/Standards/Symfony
